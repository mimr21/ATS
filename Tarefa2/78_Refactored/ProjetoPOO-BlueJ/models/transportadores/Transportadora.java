...
public abstract class Transportadora implements Serializable, ITransportadores {
     ...
     */
    public GPS getGPS() {
        return this.gps.copyGPS(this.gps);
    }
    ...
    public Map<String, PedidoTransportadora> getHistorico() {
        ...
        for(Map.Entry<String, PedidoTransportadora> e: this.historico.entrySet()){
            res.put(e.getKey(), (PedidoTransportadora) e.getValue().copyPedidoTransportadora(e.getValue()));
        }
        return res;
    }
    ...
    public void setHistorico(Map<String, PedidoTransportadora> historico) {
        ...
        for(Map.Entry<String, PedidoTransportadora> e: historico.entrySet()){
            this.historico.put(e.getKey(), (PedidoTransportadora) e.getValue().copyPedidoTransportadora(e.getValue()));
        }
    }
     ...
     * @return double correspondente a esse valor
     */
    public abstract double tempoTransporte(PedidoLoja p) throws NoSuchAlgorithmException;
    ...
    public double calculaTempoEspera(String estado){
        switch (estado){
            case "Muito" : return 0.5;
            case "Moderado" : return 0.25;
            case "Pouco" : return 0.01;
            default:return 0;
        }
    }
    ...
    public PedidoCompleto finalizaEntrega(){
        PedidoTransportadora cp = this.historico.get(this.codEncomendaAtual);
        PedidoTransportadora p = (PedidoTransportadora) cp.copyPedidoTransportadora(cp);
        this.disponivel = true;
        this.codEncomendaAtual = "None";
     ...
     */
    public abstract IPedidosTransportadores ocupaTransportadora(PedidoLoja p) throws NoSuchAlgorithmException;
    ...
    public boolean aceitaCaracteristicas(PedidoLoja p){
        ...
        return (this.gps.distancia(utilizador)<=this.raio);
     ...
     */
    public PedidoTransportadora recebeSugestao(PedidoLoja p) throws NoSuchAlgorithmException {
        ...
        return (PedidoTransportadora) pt.copyPedidoTransportadora(pt);
    }
     ...
     */
    public IPedidosTransportadores aceitarEncomenda(){
        PedidoTransportadora p = this.historico.get(this.codEncomendaAtual);
        p.setAceite(true);
        this.disponivel = false;
        return p.copyPedidoTransportadora(p);
    }
    ...
    public PedidoLoja rejeitarEncomenda(){
        ...
        return p.getPedidoLoja().copyPedidoLoja(p.getPedidoLoja());
    }
