...
public class Produto implements Serializable {
    ...
    public Produto copyProduto(Produto p){
        Produto pr = new Produto();
        pr.setCodigoProduto(p.getCodigoProduto());
        pr.setNomeProduto(p.getNomeProduto());
        pr.setPreco(p.getPreco());
        pr.setPeso(p.getPeso());
        pr.setMedicamento(p.isMedicamento());
        return pr;
    }
    ...
    /**
     * Construtor de c�pia de uma Produto
     ...
     * @param preco novo pre�o do produto
     */
    ...
    /**
     * Funcao que diz se o produto � um medicamento
