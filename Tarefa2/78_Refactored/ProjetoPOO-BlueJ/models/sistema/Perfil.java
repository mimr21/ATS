...
public class Perfil implements Serializable {
    ...
    /**
     * Construtor de c�pia de uma Perfil
     * @param p Perfil
     */
    ...
    public Perfil copyPerfil(Perfil p) {
        Perfil pe = new Perfil();
        pe.setEmail(p.getEmail());
        pe.setPass(p.getPass());
        pe.setTipo(p.getTipo());
        pe.setCodigo(p.getCodigo());
        return pe;
    }
