...
public abstract class Entidade implements IEntidade, Comparable<IEntidade>, Serializable {
    ...
    private final transient Collection<IAviso> notificacoes;
    ...
    public Collection<IAviso> getNotificacoes() {
        return this.notificacoes.stream().map(IAviso::clon).collect(Collectors.toList());
    }
