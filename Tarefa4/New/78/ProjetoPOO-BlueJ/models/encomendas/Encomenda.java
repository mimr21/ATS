...
public class Encomenda implements Serializable, IEncomendas {
   ...
   */
   ...
   public IEncomendas copyEncomenda (IEncomendas ec){
       Encomenda e = new Encomenda();
       e.setCodEncomenda(ec.getCodEncomenda());
       e.setCodUtilizador(ec.getCodUtilizador());
       e.setCodLoja(ec.getCodLoja());
       e.setPeso(ec.getPeso());
       e.setLinhasEncomenda(ec.getLinhasEncomenda());
       return e;
   }
   ...
   public List<LinhaEncomenda> getLinhasEncomenda(){
       ...
       for(LinhaEncomenda l: this.linhasEncomenda){
           res.add(l.copyLinhaEncomenda(l));
        }
       return res;
    }
   ...
   public void setLinhasEncomenda(List<LinhaEncomenda> lc){
       ...
       for(LinhaEncomenda l: lc){
           this.linhasEncomenda.add(l.copyLinhaEncomenda(l));
       }
    }
   ...
   /**
    * Metodo que devolve a representa��o em String de Encomenda.
    * 
