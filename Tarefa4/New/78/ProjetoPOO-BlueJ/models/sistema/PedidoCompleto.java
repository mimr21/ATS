...
public class PedidoCompleto implements Serializable {
    ...
    private transient IPedidosTransportadores pedidosTransportadores;
     ...
     */
    public PedidoCompleto(IPedidosTransportadores p) {
        this.codigoPedido = p.getCodigoPedido();
        this.pedidosTransportadores = ((PedidoTransportadora)p).copyPedidoTransportadora(p);
    ...
    public PedidoCompleto copyPedidoCompleto(PedidoCompleto p){
        PedidoCompleto pe = new PedidoCompleto();
        pe.setCodigoPedido(p.getCodigoPedido());
        pe.setPedidosTransportadores(p.getPedidosTransportadores());
        return pe;
    }

    /**
     * Construtor de c�pia de uma PedidoCompleto
     * @param p PedidoCompleto
     */
     ...
     */
    public IPedidosTransportadores getPedidosTransportadores() {
        if(this.pedidosTransportadores instanceof PedidoTransportadora)
            return ((PedidoTransportadora) this.pedidosTransportadores).copyPedidoTransportadora(this.pedidosTransportadores);
        else if (this.pedidosTransportadores instanceof PedidoVoluntario)
            return ((PedidoVoluntario) this.pedidosTransportadores).copyPedidoVoluntario(this.pedidosTransportadores);
        return null;
    }
     ...
     */
    public void setPedidosTransportadores(IPedidosTransportadores pedidosTransportadores) {
        if(pedidosTransportadores instanceof PedidoTransportadora)
            this.pedidosTransportadores = ((PedidoTransportadora) pedidosTransportadores).copyPedidoTransportadora(pedidosTransportadores);
        else if (this.pedidosTransportadores instanceof PedidoVoluntario)
            this.pedidosTransportadores = ((PedidoVoluntario) pedidosTransportadores).copyPedidoVoluntario(pedidosTransportadores);
    }
    ...
    public IEncomendas getEncomenda() {
        return this.pedidosTransportadores.getEncomenda().copyEncomenda(this.pedidosTransportadores.getEncomenda());
    }
    ...
    public String toString() {
        ...
        sb.append("A encomenda: ").append(this.pedidosTransportadores.getEncomenda().toString()).append("| Pre�o Loja=").append(preco).append(" | Pre�o Transporte=").append(this.pedidosTransportadores.getPreco()).append(" | Iniciada em ").append(this.pedidosTransportadores.getDataAceite().toString()).append(" | Finalizada em ").append(this.entregue.toString());
        return sb.toString();
    }
