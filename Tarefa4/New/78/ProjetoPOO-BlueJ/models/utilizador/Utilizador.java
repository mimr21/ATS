...
public class Utilizador implements Serializable {
    ...
    public Utilizador copyUtilizador(Utilizador u){
        Utilizador ut = new Utilizador();
        ut.setCodUtilizador(u.getCodUtilizador());
        ut.setGps(u.getGps());
        ut.setHistorico(u.getHistorico());
        ut.setNome(u.getNome());
        ut.setCodUtilizador(u.getCodUtilizador());
        ut.setNotificacoes(u.getNotificacoes());
        ut.setPedidosPendentes(u.getPedidosPendentes());
        return ut;
    }
    ...
    public Map<String, PedidoCompleto> getHistorico() {
        ...
        for (PedidoCompleto p: this.historico.values()){
            r.put(p.getCodigoPedido(),p.copyPedidoCompleto(p));
        }
        return r;
    }
    ...
    public void setPedidosPendentes(Map<String, PedidoTransportadora> pedidosPendentes) {
        ...
        for (Map.Entry<String, PedidoTransportadora> e : pedidosPendentes.entrySet()){
            this.pedidosPendentes.put(e.getKey(),(PedidoTransportadora) e.getValue().copyPedidoTransportadora(e.getValue()));
        }
    }
    ...
    /**
     * Metodo que quando n�o houver mais notificacoes para um utilizador
    ...
    public List<PedidoCompleto> getTransportadoresPorAvaliar(){
        ...
        for (PedidoCompleto p : this.historico.values()){
            if(!p.isAvaliado()){
                res.add(p.copyPedidoCompleto(p));
            }
        }
        return res;
    }
    ...
    public PedidoTransportadora aceitaTrasnportadora(String codEnc){
        ...
        p = (PedidoTransportadora) p.copyPedidoTransportadora(p);
