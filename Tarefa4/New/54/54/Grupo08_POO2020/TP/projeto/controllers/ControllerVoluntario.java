...
public class ControllerVoluntario {
    ...
    private float calculaTempoEntrega(IEncomenda e, String idLoja) {
        ...
        float temp = 1;
        if(id.charAt(0)=='v' || id.charAt(0) == 't'){
            temp=tempoAteCliente (id, idCliente,loja);
        }
        return tempAtend + temp;
    }

    public float tempoAteCliente(String id, String idCliente ,ILoja loja){
        ...
        return (float) distanciaAteCliente/velo + (float) distanciaAteLoja/velo;
    }
