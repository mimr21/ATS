...
public class LinhaEncomenda implements Serializable {
    ...
    */
    ...
    public LinhaEncomenda copyLinhaEncomenda (LinhaEncomenda l){
        LinhaEncomenda li = new LinhaEncomenda();
        li.setCodProduto(l.getCodProduto());
        li.setDescricao(l.getDescricao());
        li.setQuantidade(l.getQuantidade());
        li.setValor(l.getValor());
        return li;
    }
    ...
    */
    ...
    /**
     * Metodo que devolve a representa�ao em String de LinhaEncomenda.
     *
